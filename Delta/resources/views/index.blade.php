          ...
          <div class="col-xl-4 col-lg-5">
            ...
            <div class="card shadow mb-4">
               ...
               <div class="card-body">
                ...
                <h4 class="small font-weight-bold">দৈনিক লক্ষ্যমাত্রা <span class="float-right">{{(int)$goal->daily}}%</span></h4>
                ...
                <h4 class="small font-weight-bold">সাপ্তাহিক  লক্ষ্যমাত্রা <span class="float-right">{{(int)$goal->weekly}}%</span></h4>
                <div class="progress mb-4">
                ...
                <h4 class="small font-weight-bold">মাসিক  লক্ষ্যমাত্রা <span class="float-right">{{(int)$goal->monthly}}%</span></h4>
                <div class="progress mb-4">
                ...
                <h4 class="small font-weight-bold">বার্ষিক  লক্ষ্যমাত্রা <span class="float-right"> {{(int)$goal->yearly}}%</span></h4>
                <div class="progress">
