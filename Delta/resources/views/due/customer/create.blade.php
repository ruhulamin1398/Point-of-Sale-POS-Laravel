            ...
            <div class="card mb-4 shadow">
                ...
                <div class="card-header bg-abasas-dark py-3">
                    <nav class="navbar navbar-dark">
                        <h6 class="m-0 font-weight-bold ">Due Receive</h6>
                        <a href="{{ route('customer-due-receives.index') }}" class="text-light">  <button class="btn btn-success " id="create-button"> Due Received List  </button></a>
                    ...
                    <form method="POST" action="{{ route('customer-due-receives.store') }}">
                        ...
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-12 col-md-4">
                                <label for="CustomerCashAmount">Amount<span class="text-danger">*</span></label>
                            ...
                            <div class="col-12 col-md-4">
                                <button type="submit" class="btn btn-primary btn-block mt-3" id="customerCashReceiveSubmit">Submit</button>
                            </div>
