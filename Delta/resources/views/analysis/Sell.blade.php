        ...
        <div class="card-header py-3 bg-abasas-dark">
            <nav class="navbar  ">
                ...
                <div class="navbar-brand">
                    {{ __('translate.Sell Analysis') }} <span id="monthOrYear"> ({{ $data['month'] }})</span> @can('Super Admin') <i class="fas fa-tools pl-2"
         ...
         <div class="modal-content">
            ...
            <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close"><span
             ...
             <form action="{{ route('rolepermissionstore') }}" method="post">
                @csrf
                <input type="text" name="page_name" value="Sell Analysis" required hidden>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered"  width="100%"
                        ...
                        <tbody>
                            ...
                            @php
                            $permision_name = "Sell Analysis Page";
                            @endphp
