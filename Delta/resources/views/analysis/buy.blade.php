        ...
        <div class="card-header py-3 bg-abasas-dark">
            <nav class="navbar  ">
                ...
                <div class="navbar-brand">
                    {{ __('translate.Buy Analysis') }} <span id="monthOrYear"> ({{ $data['month'] }})</span>@can('Super Admin') <i class="fas fa-tools pl-2"
          ...
          <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active pt-4 p-2" id="daily" role="tabpanel" aria-labelledby="daily-tab">
                ...
                <div class="row">
                        ...
                        <div class="card border-left-info shadow h-100 py-4">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> {{ __('translate.Monthly Buy Count') }}</div>
                    ...
                    @can('Allow Supplier Due')
                    <!-- Today Buy Due Card Example -->
                    <div class="col-xl-3 col-md-6 mb-4 text-center topCard">
                        <div class="card border-left-info shadow h-100 py-4">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4 text-center topCard">
                        <div class="card border-left-info shadow h-100 py-4">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> {{ __('translate.Monthly Cash Given') }}</div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4 text-center topCard">
                        <div class="card border-left-info shadow h-100 py-4">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">{{ __('translate.Yearly Buy Count') }} </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4 text-center topCard">
                        <div class="card border-left-info shadow h-100 py-4">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> {{ __('translate.Yearly Cash Given') }}</div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4 text-center topCard">
                        <div class="card border-left-info shadow h-100 py-4">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> {{ __('translate.Total Buy Count') }}</div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4 text-center topCard">
                        <div class="card border-left-info shadow h-100 py-4">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> {{ __('translate.Total Cash Given') }}</div>
         ...
         <div class="modal-content">
            ...
            <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close"><span
             ...
             <form action="{{ route('rolepermissionstore') }}" method="post">
                @csrf
                <input type="text" name="page_name" value="Buy Analysis" required hidden>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered"  width="100%"
                        ...
                        <tbody>
                            ...
                            @php
                            $permision_name = "Buy Analysis Page";
                            @endphp
